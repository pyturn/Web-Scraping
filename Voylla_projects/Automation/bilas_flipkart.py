...
#		pdb.set_trace()
		...
		time.sleep(10)
		driver.find_element_by_link_text("Bilaspur Warehouse").click()
		time.sleep(10)
		...
		for file in files:
			if str(file) == "/home/abhinav/Desktop/Flipkart_Task/faBilaspur.csv":
				os.remove('/home/abhinav/Desktop/Flipkart_Task/faBilaspur.csv')
