...
class Flipkart(unittest.TestCase):
	...
	def test_flipkart(self):
		...
		time.sleep(5)
		driver.find_element_by_link_text("Delhi Gurgaon 1 Warehouse").click()
		time.sleep(3)
		...
		for file in files:
			if str(file) == "/home/abhinav/Desktop/Flipkart_Task/faDelhi.csv":
				os.remove('/home/abhinav/Desktop/Flipkart_Task/faDelhi.csv')
		os.rename(newest, "faDelhi.csv")
