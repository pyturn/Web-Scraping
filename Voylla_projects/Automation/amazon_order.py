...
class Amazon(unittest.TestCase):
	...
	def test_amazon(self):
		...
		time.sleep(4)
		driver.get("https://sellercentral.amazon.in/gp/ssof/reports/search.html/?ie=UTF8&recordType=AFNShipmentReport#orderAscending=&recordType=AFNShipmentReport&noResultType=&merchantSku=&fnSku=&FnSkuXORMSku=&reimbursementId=&orderId=&genericOrderId=&asin=&shipmentId=&hazmatStatus=&inventoryEventTransactionType=&inventoryAdjustmentReasonGroup=&eventDateOption=1&fromDate=dd%2Fmm%2Fyyyy&toDate=dd%2Fmm%2Fyyyy&startDate=&endDate=&eventMonthOption=1&fromMonth=2&fromYear=2016&toMonth=2&toYear=2017&startMonth=&startYear=&endMonth=&endYear=")
		time.sleep(10)
...
#		pdb.set_trace()
		...
		for file in files:
			if str(file) == "/.*tmp/fbaOrder.txt":
				os.remove('/.*tmp/fbaOrder.txt')
		os.rename(newest, 'fbaOrder.txt')
		txt_file = r"fbaOrder.txt"
		csv_file = r"fbaOrder.csv"
