...
#		self.driver.implicitly_wait(30)
	...
	def test_flipkart(self):
		...
		time.sleep(10)
		driver.find_element_by_link_text("Jaipur Mini FC Sitapur").click()
		time.sleep(10)
		...
		for file in files:
			if str(file) == "/home/abhinav/Desktop/Flipkart_Task/faJaipur.csv":
				os.remove('/home/abhinav/Desktop/Flipkart_Task/faJaipur.csv')
		os.rename(newest, "faJaipur.csv")
