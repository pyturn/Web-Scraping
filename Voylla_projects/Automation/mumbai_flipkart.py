...
#		self.driver.implicitly_wait(30)
	...
	def test_flipkart(self):
		...
		driver.find_element_by_id("username").send_keys("enter_youtr_id")
...
#			pdb.set_trace()
		...
		time.sleep(10)
		driver.find_element_by_link_text("Mumbai Bhiwandi Warehouse").click()
		time.sleep(10)
		...
		for file in files:
			if str(file) == "/home/abhinav/Desktop/Flipkart_Task/faMumbai.csv":
				os.remove('/home/abhinav/Desktop/Flipkart_Task/faMumbai.csv')
		os.rename(newest, "faMumbai.csv")
